...
sim.add_object("../object/geomobj/models/box.xml", pos = "0.5 0.0 2", size = "0.03 0.03 0.12", mass = "0.5", color= "0 1 0 1")
...
offset_lift_pose = [0.9, 0.0, 0.55, 0.7071068, 0.0, 0.7071068, 0.0]
bt_definition = [
    "Sequence",["Sequence", ["MovePose", {"target_pose": offset_pose}],["OpenGripper", {}],["MovePose", {"target_pose": object1_pose}],["CloseGripper", {}],["Parallel",["MovePose", {"target_pose": offset_lift_pose}],["MeasureAppliedForce", {}]], ["MovePose", {"target_pose": object1_pose}],["OpenGripper", {}]]]
